...
urlpatterns = [
    ...
    path('ess/documents/',           views.ESSDocumentsView.as_view(),            name='ess_documents'),
    path('ess/directory/',           views.ESSDirectoryView.as_view(),            name='ess_directory'),
    path('ess/help/',                views.ESSHelpView.as_view(),                 name='ess_help'),
    path('ess/shifts/',              views.ESSShiftsView.as_view(),               name='ess_shifts'),
    path('ess/password/change/',     views.ESSPasswordChangeView.as_view(),       name='ess_password_change'),
    path('ess/loans/',               views.ESSLoansView.as_view(),                name='ess_loans'),
    path('ess/assets/',              views.ESSAssetsView.as_view(),               name='ess_assets'),
    path('ess/performance/',         views.ESSPerformanceView.as_view(),          name='ess_performance'),
    path('ess/training/',            views.ESSTrainingView.as_view(),            name='ess_training'),
    path('ess/expenses/',            views.ESSExpensesView.as_view(),            name='ess_expenses'),
    path('ess/overtime/',            views.ESSOvertimeView.as_view(),            name='ess_overtime'),
    path('ess/grievance/',           views.ESSGrievanceView.as_view(),           name='ess_grievance'),
    path('ess/tax-documents/',       views.ESSTaxDocumentsView.as_view(),        name='ess_tax_documents'),
